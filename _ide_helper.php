...
namespace Illuminate\Support\Facades {
     ...
     */        class Auth {
         ...
         *
         * @return \Modules\Market\app\Models\User|null
         * @static 
         ...
         *
         * @param mixed $id
         * @return \Modules\Market\app\Models\User|false
         * @static 
         ...
         *
         * @return \Modules\Market\app\Models\User
         * @static 
...
namespace Shipu\Themevel\Facades {
     ...
     */        class Theme {
        ...
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        $instance->set($theme);
        }
                    /**
        ...
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->has($theme);
        }
                    /**
         * Get particular theme all information.
         *
         * @param string $themeName
         * @return null|\Shipu\Themevel\Managers\ThemeInfo 
         * @static 
         */        public static function getThemeInfo($themeName)
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->getThemeInfo($themeName);
        }
                    /**
         ...
         * @return array|null|\Shipu\Themevel\Managers\ThemeInfo 
         * @static 
         */        public static function get($theme = null, $collection = false)
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->get($theme, $collection);
        }
                    /**
         ...
         * @return null|\Shipu\Themevel\Managers\ThemeInfo 
         * @static 
         */        public static function current($collection = false)
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->current($collection);
        }
                    /**
        ...
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->assets($path, $secure);
        }
                    /**
        ...
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->getFullPath($path);
        }
                    /**
         ...
         * @static 
         */        public static function themeMix($path, $manifestDirectory = '')
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->themeMix($path, $manifestDirectory);
        }
                    /**
         ...
         * @static 
         */        public static function lang($fallback, $replace = [], $locale = null)
        {
                        /** @var \Shipu\Themevel\Managers\Theme $instance */
                        return $instance->lang($fallback, $replace, $locale);
        }
            }
    }
...
namespace  {
            ...
            class Theme extends \Shipu\Themevel\Facades\Theme {}
