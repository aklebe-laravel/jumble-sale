...
return [
    ...
    */
    ...
    'paths'      => [
        ...
        */
        'generator'  => [
            ...
            // resource/
            'resources'       => ['path' => 'resources', 'generate' => false],
    ...
    |
    */
    'commands'   => ConsoleServiceProvider::defaultCommands()->merge([// New commands go here
    ])->toArray(),
    ...
    */
    'composer'   => [
        'vendor'          => env('MODULE_VENDOR', 'aklebe'),
        'author'          => [
            'name'  => env('MODULE_AUTHOR_NAME', 'Andreas Klebe'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'a.klebe.work@gmail.com'),
        ],
